// ResetPassword.jsx - White & Blue Professional Theme
    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-white to-blue-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="bg-blue-600 px-6 py-8 text-center">
          ...
          <p className="text-blue-100 mt-2">Enter OTP and new password</p>
        </div>
          ...
          <form onSubmit={handleResetPassword}>
            <div className="mb-4">
              ...
              {emailFromUrl && (
                <p className="text-xs text-gray-500 mt-1">
                  Email pre-filled from request. Change if needed.
                </p>
              )}
            </div>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded-lg text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
